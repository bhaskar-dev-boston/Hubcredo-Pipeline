...
export function CrmSettings() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Connection status */}
      {loading ? (
        <div className="flex items-center gap-3 p-4 bg-[#F8FAFC] border border-[rgba(255,255,255,.08)] rounded-2xl">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          ...
          { icon: <RefreshCw className="w-4 h-4 text-[#4f46e5]" />, title: "On reply", desc: "Note pushed to Attio contact" },
      ...
      {/* Setup instructions */}
      <div className="bg-[#F8FAFC] border border-[rgba(255,255,255,.08)] rounded-2xl p-5 space-y-3">
        <h4 className="text-sm font-semibold text-white">Setup</h4>
        <ol className="space-y-2">
          {[
            <>In Attio: <strong>Workspace Settings → Developers → New access token</strong>. Enable <code className="text-xs bg-[rgba(255,255,255,.04)] border border-[rgba(255,255,255,.08)] px-1 rounded">record_permission:read-write</code> and <code className="text-xs bg-[rgba(255,255,255,.04)] border border-[rgba(255,255,255,.08)] px-1 rounded">note:read-write</code>.</>,
            <>In Replit: open <strong>Secrets</strong> (lock icon) → add key <code className="text-xs bg-[rgba(255,255,255,.04)] border border-[rgba(255,255,255,.08)] px-1 rounded">ATTIO_API_KEY</code> → paste your token.</>,
