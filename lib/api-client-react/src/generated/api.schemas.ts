...
export type CrmConnectionFieldMapping = { [key: string]: unknown };
...
export interface CrmFieldMapping {
  mapping: CrmFieldMappingMapping;
}

export type CrmFieldMappingInputMapping = { [key: string]: unknown };
...
export type PushCrmActivity200 = {
  success?: boolean;
};
